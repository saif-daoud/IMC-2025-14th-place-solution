...
from tasks.matching.core.accelerated_features.modules.model import *
from tasks.matching.core.accelerated_features.modules.interpolator import InterpolateSparse2d
...
class XFeat(nn.Module):
	...
	def __init__(self, weights = os.path.abspath(os.path.dirname(__file__)) + '/../weights/xfeat.pt', top_k = 4096, device='cuda'):
		super().__init__()
		self.dev = device
